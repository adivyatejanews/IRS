...
public class Children extends AbstractEntity implements Serializable {
	...
	@Column(name = "first_name", length = 200, columnDefinition = "nvarchar(200)")
	...
	@Column(name = "mother_first_name", length = 200, columnDefinition = "nvarchar(200)")
	...
	//0 - unidentify, 1 - yes, 2 - no
	@Column(name = "protected_tetanus")
	private Short protectedTetanus;	
	...
	public Short getProtectedTetanus() {
		return protectedTetanus;
	}

	public void setProtectedTetanus(Short protectedTetanus) {
		this.protectedTetanus = protectedTetanus;
	}
